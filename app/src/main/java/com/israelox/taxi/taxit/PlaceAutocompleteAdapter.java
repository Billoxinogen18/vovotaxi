...
public class PlaceAutocompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        Log.i("Ncy", "Starting autocomplete query for: " + constraint);
        ...
        try {
            ...
            Log.i("Fan", "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
            ...
            Log.e("Dat", "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}