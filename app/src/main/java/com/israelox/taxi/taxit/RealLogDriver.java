...
public class RealLogDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_real_log);
                ...
                if(task.isSuccessful()){
                    ...
                    mUserDatabase.child(current_user_id).child("device_token").setValue(deviceToken).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Intent mainIntent = new Intent(RealLogDriver.this, DriverMapActivity.class);
                    ...
                    Toast.makeText(RealLogDriver.this, "Error : " + task_result, Toast.LENGTH_LONG).show();
